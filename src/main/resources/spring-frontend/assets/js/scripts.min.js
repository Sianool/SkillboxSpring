    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="/books/' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    (book.status === 'KEPT' ? ' <a class="Card-status" title="Отложена"><img src="/assets/img/icons/heart.svg" alt="Отложена"></a>\n' : '') + '    </div>' + '              <div class="Card-content">\n' + '                <strong class="Card-title"><a href="/books/' + book.slug + '">' + book.title + '</a>\n' + '                </strong>\n' + '                <div class="Card-description">' + book.author.firstName + ' ' + book.author.lastName + '                </div>\n' + '                <div class="Card-cost">' +
