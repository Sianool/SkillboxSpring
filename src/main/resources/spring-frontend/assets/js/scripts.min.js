    ...
    $(function () {
                        ...
                        function reloadDate() {
                            ...
                            if ($window.width() > 990) {
                                ...
                                $dateInputs.filter('[name="fromdaterecent"]').each(function () {
                                    var $this = $(this);
                                    today.setYear(today.getYear() - 122);
                                    $this.datepicker().data('datepicker').update({maxDate: new Date()}).selectDate(today);
                                });
                            } else {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="/book/' + book.slug + '">' + '       <img src="' + book.image + '">\n' +
                    (book.discount ? '<div class="Card-sale">' + book.percentDiscount + '% скидка</div>' : '') +
                    (book.isBestseller ? '<div class="Card-ribbon"><span class="Card-ribbonText">Бестселлер</span></div>' : '') + '</a>' +
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'genre':
                                ...
                                break;
                            case'author':
                                // getData('/books/author/'
                                getData('/newPage/author/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/books/changeBookStatus/' + $this.data('bookid') + "/" + status, {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
